                    ...
                    <div class="flex flex-wrap items-center justify-center md:justify-between">
                        ...
                        <div class="w-full px-4 md:w-8/12">
                            <ul class="flex flex-wrap justify-center list-none md:justify-end">
                                <li>
                                    <a href="https://www.creative-tim.com"
                                        class="block px-3 py-1 text-sm font-semibold text-white hover:text-gray-400">Creative
                                        Tim</a>
                                </li>
                                <li>
                                    <a href="https://www.creative-tim.com/presentation"
                                        class="block px-3 py-1 text-sm font-semibold text-white hover:text-gray-400">About
                                        Us</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="https://github.com/creativetimofficial/argon-design-system/blob/master/LICENSE.md"
                                        class="block px-3 py-1 text-sm font-semibold text-white hover:text-gray-400">MIT
                                        License</a>
                                </li>
                            </ul>
                        </div>
